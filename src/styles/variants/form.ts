...
export const formField = tv({
  slots: {
    ...
    input:
      "w-full border border-dark-500 rounded-md bg-dark-300 text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 placeholder:text-gray-500",
