...
export const navbar = tv({
  slots: {
    container:
      "fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-md border-b border-dark-400",
    ...
    userAvatar:
      "w-8 h-8 rounded-full bg-green-500/20 border border-green-500 flex items-center justify-center text-green-500 font-semibold",
...
export const navlink = tv({
  ...
  variants: {
    ...
    underline: {
      ...
      false:
        "hover:after:absolute hover:after:bottom-0 hover:after:left-0 hover:after:right-0 hover:after:h-0.5 hover:after:bg-green-500 hover:after:scale-x-0 hover:after:hover:scale-x-100 hover:after:transition-transform",
    },
  },
  defaultVariants: {
    variant: "default",
