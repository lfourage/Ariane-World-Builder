...
export const modal = tv({
  ...
  variants: {
    size: {
      sm: {
        container:
          "w-[calc(100vw-24px)] max-w-[320px] sm:max-w-sm max-h-[90vh] overflow-y-auto p-4 sm:p-5",
        header: "mb-3 sm:mb-4",
      ...
      md: {
        container:
          "w-[calc(100vw-24px)] max-w-md sm:max-w-lg max-h-[90vh] overflow-y-auto p-5 sm:p-6",
        header: "mb-4 sm:mb-6",
      ...
      lg: {
        container:
          "w-[calc(100vw-24px)] max-w-lg sm:max-w-2xl max-h-[90vh] overflow-y-auto p-6 sm:p-8",
        header: "mb-5 sm:mb-7",
